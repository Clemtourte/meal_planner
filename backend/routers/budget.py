...
async def create_budget(
    payload: BudgetCreate, db: Client = Depends(get_supabase)
) -> dict:
...
async def get_budget_actuel(db: Client = Depends(get_supabase)) -> list[dict]:
...
async def get_historique(db: Client = Depends(get_supabase)) -> list[dict]:
...
async def add_historique(
    payload: DepenseHistoriqueCreate, db: Client = Depends(get_supabase)
) -> dict:
